            ...
            <div id="home" className="landing-wrapper overflow-hidden">
                <div className="py-4 px-4 mx-0 md:mx-6 lg:mx-8 lg:px-8 flex align-items-center justify-content-between relative lg:static">
                    <Link href="/" className="flex align-items-center">
                        <img src={`/layout/images/logo.png`} width="94.44px" height="70px" alt="logo"/>
                        <span className="text-900 font-medium text-2xl line-height-3 mr-8">RestoRun</span>
                    </Link>
                    ...
                    <div className={classNames('align-items-center surface-0 flex-grow-1 justify-content-between hidden lg:flex absolute lg:static w-full left-0 px-6 lg:px-0 z-2', { hidden: isHidden })} style={{ top: '100%' }}>
                        ...
                        <div className="flex justify-content-between lg:block border-top-1 lg:border-top-none surface-border py-3 lg:py-0 mt-3 lg:mt-0">
                            <Button label="Login" onClick={() => router.push('/auth/login')} text rounded className="border-none font-light line-height-2 text-blue-500"></Button>
                ...
                >
                    <div className="mx-4 md:mx-8 mt-0 md:mt-4">
                        ...
                        <p className="font-normal text-2xl line-height-3 md:mt-3 text-gray-700">
                            ...
                            <span>Fast & reliable for easy payments for customers.</span>
