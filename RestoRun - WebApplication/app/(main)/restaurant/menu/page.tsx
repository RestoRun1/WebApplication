...
const MenuPage = () => {
    ...
    const handleDelete = async (id: string) => {
        ...
        if (!id) {
            console.error('Error: No valid meal ID provided for deletion.');
            return;
        }
        try {
    ...
    const renderModalContent = () => {
        return (
            <Dialog visible={mealDialog} style={{width: '450px'}} header="Meal Details" modal className="p-fluid"
                    footer={mealDialogFooter} onHide={hideDialog}>
                ...
                <div className="field">
                    ...
                    <div className="formgrid grid">
                        <div className="field-radiobutton col-6">
                            <RadioButton inputId="category1" name="category" value="APPETIZER"
                                         onChange={(e) => setCategory(e.target.value)}
                                         checked={category === 'APPETIZER'}/>
                            <label htmlFor="category1">APPETIZER</label>
                        </div>
                        <div className="field-radiobutton col-6">
                            <RadioButton inputId="category2" name="category" value="MAIN_COURSE"
                                         onChange={(e) => setCategory(e.target.value)}
                                         checked={category === 'MAIN_COURSE'}/>
                            <label htmlFor="category2">MAIN_COURSE</label>
                        </div>
                        <div className="field-radiobutton col-6">
                            <RadioButton inputId="category3" name="category" value="DESSERT"
                                         onChange={(e) => setCategory(e.target.value)}
                                         checked={category === 'DESSERT'}/>
                            <label htmlFor="category3">DESSERT</label>
                        </div>
                        <div className="field-radiobutton col-6">
                            <RadioButton inputId="category4" name="category" value="DRINK"
                                         onChange={(e) => setCategory(e.target.value)} checked={category === 'DRINK'}/>
                            <label htmlFor="category4">DRINK</label>
                        </div>
                    </div>
                </div>
                ...
                <div className="formgrid grid">
                    <div className="field col">
                        ...
                        <InputNumber id="price" value={price} onValueChange={(e) => setPrice(e.target.value)}
